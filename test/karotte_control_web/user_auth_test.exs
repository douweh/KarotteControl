defmodule KarotteControlWeb.UserAuthTest do
  use KarotteControlWeb.ConnCase, async: true

  alias KarotteControl.Accounts
  alias KarotteControl.Accounts.Scope
  alias KarotteControlWeb.UserAuth

  import KarotteControl.AccountsFixtures
  ...
  setup %{conn: conn} do
    conn =
      conn
      |> Map.replace!(:secret_key_base, KarotteControlWeb.Endpoint.config(:secret_key_base))
      |> init_test_session(%{})
