defmodule KarotteControl.Application do
  ...
  def start(_type, _args) do
    ...
    opts = [strategy: :one_for_one, name: KarotteControl.Supervisor]
  ...
  def config_change(changed, _new, removed) do
    KarotteControlWeb.Endpoint.config_change(changed, removed)
    :ok
  end
end
